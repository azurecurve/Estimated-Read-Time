 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_ert')){
	function azrcrv_create_plugin_menu_ert(){
		azrcrv_populate_plugin_menu_ert();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_ert')){
	function azrcrv_populate_plugin_menu_ert(){
